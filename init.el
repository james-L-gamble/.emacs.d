...
(custom-set-variables
 ...
 '(package-selected-packages
   '(lsp-ui vterm company-racer lsp-mode doom-themes acme-theme atom-one-dark-theme adwaita-dark-theme 2048-game abyss-theme fireplace evil-visual-mark-mode haskell-mode rust-mode)))
(custom-set-faces
