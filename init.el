;;External Dependencies: libvterm, Xorg (For Caps -> Ctrl mapping),
...
(custom-set-variables
 ...
 '(custom-safe-themes
   '("de8f2d8b64627535871495d6fe65b7d0070c4a1eb51550ce258cd240ff9394b0"
     ...
     default))
 '(org-agenda-files
   '("~/org/notes/database/2-19-26.org"
     "/home/firebox/org/notes/cybersec/2-12-26.org"
     "/home/firebox/org/notes/v&v/2-9-26.org"
     "/home/firebox/org/notes/cybersec/2-5-26.org"))
 '(package-selected-packages
   '(2048-game abyss-theme acme-theme adwaita-dark-theme alarm-clock
	       atom-one-dark-theme company-racer dap-mode devil
	       doom-themes evil-surround evil-tutor
	       evil-visual-mark-mode exwm fireplace god-mode
	       haskell-mode lsp-java lsp-mode lsp-ui multiple-cursors
	       nano-theme qrencode rainbow-delimiters rust-mode
	       typescript-mode volume vterm))
...
(keymap-global-set "C-c t s" 'shell)
(keymap-global-set "C-c s c" 'comint-clear-buffer)
(keymap-global-set "C-c l" 'lsp)


;; Uses xorg keymaps to make capslock an extra control
;; If running in an environment without x installed/enabled, god help you.       
...
(eval-after-load 'exwm
  '(keymap-global-set "s-<tab>" 'next-buffer))
